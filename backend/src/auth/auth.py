...
AUTH0_DOMAIN = 'alx-fullstack-coffee-shop.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'fullstack-coffee-shop'
...
def get_token_auth_header():
    ...
    header_part = header_auth.split(' ')
    if not header_auth or len(header_part) != 2 or header_part[0].lower() != 'bearer':
...
def check_permissions(permissions, payload):
    ...
    for permit in permissions:
        if permit not in payload['permissions']:
